...
namespace eval ::optrace {
  variable script "C:/Users/ST/Desktop/myVivado/Testprojects/Ethernet+py script to send required data/Ethernet+py script to send required data.runs/impl_1/design_1_wrapper.tcl"
...
OPTRACE "add files" START { }
  add_files -quiet {{C:/Users/ST/Desktop/myVivado/Testprojects/Ethernet+py script to send required data/Ethernet+py script to send required data.runs/synth_1/design_1_wrapper.dcp}}
